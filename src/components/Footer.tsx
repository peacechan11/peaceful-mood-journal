      ...
      <div className="container-wide">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-2">
              <div className="w-7 h-7 rounded-full bg-gradient-to-tr from-peace-400 to-serenity-500 shadow-peace flex items-center justify-center">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Your personal space for mindfulness, reflection, and community support.
            </p>
          </div>
          ...
          <div>
            <h4 className="font-medium text-foreground mb-4">Subscribe</h4>
        ...
        <div className="mt-12 pt-6 border-t border-border flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {currentYear} PeaceSync. All rights reserved.
          </p>
